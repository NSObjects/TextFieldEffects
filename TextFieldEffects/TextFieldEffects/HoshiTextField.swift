...
@IBDesignable public class HoshiTextField: TextFieldEffects {
    ...
    @IBInspectable dynamic public var PHNormalColor: UIColor = .blackColor() {
        didSet {
            updatePlaceholder()
        }
    }
    
    @IBInspectable dynamic public var PHHightLightColor: UIColor = .blackColor() {
        didSet {
            updatePlaceholder()
        }
    }
    ...
    */
    ...
    /**
     The font of the placeholder font.
     
   
     */
    @IBInspectable dynamic public var PHFontSize: CGFloat = 16 {
        didSet {
            updatePlaceholder()
        }
    }
    
    @IBInspectable dynamic public var PHFontFamily: String = "Helvetica-Bold" {
        didSet {
            updatePlaceholder()
        }
    }
    ...
    override public func animateViewsForTextEntry() {
        self.placeholderLabel.textColor = self.PHHightLightColor
        self.placeholderLabel.font = UIFont(name: self.PHFontFamily, size: self.PHFontSize)
        if text!.isEmpty {
    ...
    override public func animateViewsForTextDisplay() {
        ...
        if text!.isEmpty {
            ...
            self.placeholderLabel.textColor = self.PHNormalColor
    ...
    private func updatePlaceholder() {
        ...
        if isFirstResponder() || text!.isNotEmpty {
            ...
            placeholderLabel.textColor = PHNormalColor
            placeholderLabel.font = UIFont(name: PHFontFamily, size: PHFontSize)
        } else {
            placeholderLabel.textColor = PHHightLightColor
